    ...
    if (vm.currentStep === 3) {
      ...
      for (var i = 0; i < $scope.choices.length; i++) {
        if ($scope.choices[i].payment || $scope.choices[i].timelimit || $scope.choices[i].datalimit) {
          table.push({
            payment: $scope.choices[i].payment,
            timelimit: $scope.choices[i].timelimit,
            datalimit: $scope.choices[i].datalimit
          });
          console.log(table)
        }
      }
      var link = "http://commonsnet.herokuapp.com/#/file?ssid=" + vm.ssid + "&isp=" + vm.isp + "&password=" + vm.password + "&loginname=" + vm.loginname + "&paid=" + vm.paidfield + "&speed=" + vm.datarate + "&standard=" + vm.wifistandards + "&security=" + vm.securitytypes + "&service=" + vm.servicefield + "&captiveportal=" + vm.captiveportal + "&specialdevices=" + vm.specialdevices + "&devices=" + vm.specialdevicesfield + "&specialsettings=" + vm.specialsettings + "&settings=" + vm.specialsettingsfield + "&acceptterms=" + vm.acceptterms + "&liking=" + vm.socialprofile + "&downloading=" + vm.downloading + "&register=" + vm.register + "&newsletter=" + vm.newsletter + "&mobilenumber=" + vm.mobilenumber + "&emailaddress=" + vm.emailaddress + "&personaldetails=" + vm.personaldetails + "&autodisable=" + vm.autoupdatedisabled + "&rnumber=" + vm.referencenumber + "&isplimits=" + vm.isprestrictionsfield + "&db=" + vm.dualbandyes + "&nodf=" + vm.limitdevicesfield

 app.controller('ContactCtrl', function ($scope, $http) {
        ...
        $scope.subtitle2 = 'Please note: we are a distributed team working all over the world. We don’t have an office, but if you need to send us an  email please us above form or send it to:'
        $scope.address = 'commonsnet.team@gmail.com '
        $scope.title3 = 'Reporting bugs on CommonsNet website'
